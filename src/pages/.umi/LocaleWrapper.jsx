...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('E:/workSpace/car_rule_manage_web/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('E:/workSpace/car_rule_manage_web/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('E:/workSpace/car_rule_manage_web/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('E:/workSpace/car_rule_manage_web/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
