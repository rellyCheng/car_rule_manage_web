export default {
  ...
  'menu.workers': '工人管理',
  'menu.credit': '信用查询',
  'menu.credit.badnesscompany': '企业不良行为信息',
  'menu.credit.goodcompany': '企业良好行为信息',
  'menu.credit.blackcompany': '企业黑名单信息',
  'menu.credit.badnessstaff': '人员不良行为信息',
  'menu.credit.goodstaff': '人员良好行为信息',
  'menu.credit.blackstaff': '人员黑名单信息',
  ...
  'menu.createForm.companyForm':'企业表单',
  'menu.createForm.projectForm':'项目表单',
  'menu.createForm':'全国建筑工人平台对接',
  'menu.allCountry':'全国建筑工人平台对接',
  'menu.environment':'环境监测',
  'menu.createForm.uploadExcel':'上传EXCEL',
  'menu.createForm.projectInfo':'查询项目信息',
  'menu.createForm.teamInfo':'查询班组信息',
  'menu.createForm.uploadCJInfo':'上传参建单位信息',
  'menu.createForm.uploadTeamInfo':'上传班组信息',
  'menu.createForm.uploadProjectGRInfo':'上传项目工人信息',
  'menu.corporateAccount':'内部管理',
  'menu.corporateAccount.workManage':'员工管理',
  'menu.supervisedAccount':'监管型账号',
  'menu.supervisedAccount.projectManage':'项目管理',
  'menu.regionalSupervisionAccount':'区域监管账号',
  'menu.regionalSupervisionAccount.projectManage':'项目管理',
  'menu.business':'企业管理',
  'menu.regionalSupervisionAccount.corpManage':'企业管理',
  'menu.winsheAccount':'匀视管理账号',
  'menu.winsheAccount.userAccountManagement':'用户账号管理',
  'menu.winsheAccount.unuploadedWorker':'未上传工人管理',
  'menu.winsheAccount.projectManagement':'项目管理',
  'menu.winsheAccount.corpManagement':'企业管理',
  'menu.winsheSuperManage':'匀视超级管理后台',
  'menu.winsheSuperManage.bindingAccount':'申请绑定住建部账号',
  'menu.companyUpload':'企业上传',
  'menu.countryPlatform':'全国建筑工人平台对接',
  'menu.plumberPlatform':'管工平台',
  'menu.plumberPlatform.projectseniormanage':'项目管理(企业高级管理员查看)',
  'menu.plumberPlatform.projectCommonManage':'项目管理(企业一般管理员查看)',
  'menu.plumberPlatform.business': '企业管理',
  'menu.countryPlatform.companyUpload':'企业上传',
  'menu.countryPlatform.employeeUpload':'员工上传管理',
  'menu.countryPlatform.item':'项目上传',
  'menu.plumberPlatform.gongren': '工人管理',
  'menu.winsheAccount.bindingAccount':'住建部账号管理',
  'menu.insideManage':'内部管理',
  "menu.insideManage.workManage":'员工管理'
};
